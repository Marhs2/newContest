    ...
    <main>
      <div class="all-container">
        <div class="contents">
          ...
          브랜딩, 마케팅 채널로 진화하고 있습니다. <br />
          <br />
          고객의 니즈를 반영하는 온라인 PLAYGROUND를 제공합니다. <br />
          우리는 차별화된 온라인 콘텐츠와 AI기술 기반 상품 추천을 통해 월 이용자
          수 480만명, 멤머십 회원 수 1,400만명 이상의 선물 커뮤니티를
          구현했습니다. <br />
          ...
          수행합니다. <br />
          2024년 런칭한 글로벌몰과 연간 약 300만명 이상이 외국인 고객이 방문하는
          국내 글로벌 특화매장은 파트너사와 함께 글로벌 시장에서 동반 성장을 할
          수 있는 핵심 원동력입니다. <br />

          가치지향 라이프스타일 플랫폼을 통해 고객에게 다양한 즐거움을
          선물합니다. 고객이 라이프스타일 전반에서 자신만의 가치와 취향을 반영한
          브랜드를 탐색할 수 있습니다. 이러한 고객 경험
        </div>
      </div>
