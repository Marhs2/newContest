...
<body>
  ...
  <div class="slide">
    ...
    <ul>
      <li class="slide01">
        <div class="imgCover">
          <img src="../images/slide01.jpg" alt="slide01Img" />
        </div>
      ...
      <li>
        <div class="imgCover">
          <img src="../images/slide02.jpg" alt="slide02Img" />
        </div>
        <div class="slide-content">
          <div class="slideTitle">
      ...
      <li>
        <div class="imgCover">
          <img src="../images/slide03.jpg" alt="slide03Img" />
        </div>
        <div class="slide-content">
          <div class="slideTitle">
            <span>B</span>etter <span>G</span>ive & <span>T</span>ake
  ...
  <main>
    <div class="all-container">
      <div class="sale">
        <div class="title">SALE PRODCUT</div>

        <input type="radio" name="sale-fil" id="healty" checked />
        <input type="radio" name="sale-fil" id="digi" />
        <input type="radio" name="sale-fil" id="fancy" />
        <input type="radio" name="sale-fil" id="smell" />
        <input type="radio" name="sale-fil" id="hair" />

        <div class="sale-filter">
          <label for="healty">건강식품</label>
          <label for="digi">디지털</label>
          <label for="fancy">펜시</label>
          <label for="smell">냄새</label>
              ...
              <div class="item-content">
                ...
                <div class="item-about">
                  ...
                  <div class="item-drive">
                    일반배송 2,500원 (20,000원 이상 무료배송)
                  </div>
                  <div class="item-bonuce1">
                    결재혜택 GIFTS카드 추가 10% 할인
                  </div>
                  <div class="item-bonuce2">
            ...
            <div class="item">
              ...
              <div class="item-content">
                ...
                <div class="item-about">
                  ...
                  <div class="item-price">가격: 27,000</div>
                  <div class="item-drive">
                    일반배송 2,500원 (20,000원 이상 무료배송)
                  </div>
                  <div class="item-bonuce1">
            ...
            <div class="item">
              ...
              <div class="item-content">
                ...
                <div class="item-about">
                  ...
                  <div class="item-price">가격: 2,000</div>
                  <div class="item-drive">
                    일반배송 2,500원 (20,000원 이상 무료배송)
                  </div>
                  <div class="item-bonuce1">
            ...
            <div class="item">
              ...
              <div class="item-content">
                ...
                <div class="item-about">
                  ...
                  <div class="item-price">가격: 24,400</div>
                  <div class="item-drive">
                    일반배송 2,500원 (20,000원 이상 무료배송)
                  </div>
                  <div class="item-bonuce1">
            ...
            <div class="item">
              ...
              <div class="item-content">
                ...
                <div class="item-about">
                  ...
                  <div class="item-price">가격: 36,900</div>
                  <div class="item-drive">
                    일반배송 2,500원 (20,000원 이상 무료배송)
                  </div>
                  <div class="item-bonuce1">
              ...
              <div class="item-content">
                ...
                <div class="item-about">
                  <div class="item-sub">
                    ...
                    최소화, 프리미엄 PCB기판 채용으로 안정적이고 편안한 타건감
                    제공
                  </div>
                  <div class="item-price">가격: 70,750</div>
                  <div class="item-drive">
                    일반배송 2,500원 (20,000원 이상 무료배송)
                  </div>
                  <div class="item-bonuce1">
            ...
            <div class="item">
              ...
              <div class="item-content">
                ...
                <div class="item-about">
                  ...
                  <div class="item-price">가격: 31,600</div>
                  <div class="item-drive">
                    일반배송 2,500원 (20,000원 이상 무료배송)
                  </div>
                  <div class="item-bonuce1">
            ...
            <div class="item">
              ...
              <div class="item-content">
                ...
                <div class="item-about">
                  ...
                  <div class="item-price">가격: 250,000</div>
                  <div class="item-drive">
                    일반배송 3,000원 (20,000원 이상 무료배송)
                  </div>
                  <div class="item-bonuce1">
                    결재혜택 GIFTS카드 추가 10% 할인
                  </div>
            ...
            <div class="item">
              ...
              <div class="item-content">
                ...
                <div class="item-about">
                  ...
                  <div class="item-price">가격: 265,000</div>
                  <div class="item-drive">
                    일반배송 3,000원 (20,000원 이상 무료배송)
                  </div>
                  <div class="item-bonuce1">
            ...
            <div class="item">
              ...
              <div class="item-content">
                ...
                <div class="item-about">
                  ...
                  <div class="item-price">가격: 26,000</div>
                  <div class="item-drive">
                    일반배송 2,500원 (20,000원 이상 무료배송)
                  </div>
                  <div class="item-bonuce1">
            ...
            <div class="item">
              ...
              <div class="item-content">
                ...
                <div class="item-about">
                  ...
                  <div class="item-price">가격: 153,000</div>
                  <div class="item-drive">
                    일반배송 2,500원 (20,000원 이상 무료배송)
                  </div>
                  <div class="item-bonuce1">
            ...
            <div class="item">
              ...
              <div class="item-content">
                ...
                <div class="item-about">
                  ...
                  <div class="item-price">가격: 64,500</div>
                  <div class="item-drive">
                    일반배송 2,500원 (20,000원 이상 무료배송)
                  </div>
                  <div class="item-bonuce1">
            ...
            <div class="item">
              ...
              <div class="item-content">
                ...
                <div class="item-about">
                  ...
                  <div class="item-price">가격: 29,800</div>
                  <div class="item-drive">
                    일반배송 2,500원 (20,000원 이상 무료배송)
                  </div>
                  <div class="item-bonuce1">
            ...
            <div class="item">
              ...
              <div class="item-content">
                ...
                <div class="item-about">
                  ...
                  <div class="item-price">가격: 21,900</div>
                  <div class="item-drive">
                    일반배송 2,500원 (20,000원 이상 무료배송)
                  </div>
                  <div class="item-bonuce1">
            ...
            <div class="item">
              ...
              <div class="item-content">
                ...
                <div class="item-about">
                  ...
                  <div class="item-price">가격: 19,800</div>
                  <div class="item-drive">
                    일반배송 2,500원 (20,000원 이상 무료배송)
                  </div>
                  <div class="item-bonuce1">
      ...
      <div class="notice">
        ...
        <div class="notice-container">
          ...
          <div class="notice-filter">
            <div class="notice-date-filter">
              <div class="ASC">ASC</div>
              <div class="DESC">DESC</div>
            </div>

            <div class="notice-type-filter">
      ...
      <div class="support-contect">
        <div class="title">SUPPORT / CONTECT</div>
        <div class="bar">
          대한민국 No.1 <br />
          GIFTS:Mall과 함께 할 WIN-WIN 파트너를 찾습니다. <br />
          제휴사의 많은 지원을 기다립니다. <br />
        </div>
        ...
        <div class="banner-container">
          <div class="banner-contnet">
            <div class="banner">상품입점/제휴문의</div>
            <div class="banner">문의결과조회</div>
          </div>
          <div class="banner-contnet">
            <div class="banner">전자계약시스템</div>
            <div class="banner">파트너시스템</div>
          </div>
        </div>
        ...
        <div class="support">
          <div class="stage01">
            ...
            <div class="stage-sub">임시회원가입</div>
          ...
          <span>&gt;</span>
          <div class="stage05">
            <div class="stage-title">5단계</div>
            <div class="stage-sub">신용평가</div>
            <div class="stage-content">
          ...
          <span>&gt;</span>
          <div class="stage06">
            <div class="stage-title">6단계</div>
            <div class="stage-sub">계약체결</div>
            <div class="stage-content">
